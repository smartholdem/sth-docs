...
module.exports = {
  ...
  */
  head: {
    ...
    title: brand.sth_docs.desc,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.sth_docs.desc },
      { name: 'msapplication-TileColor', content: '#FFFFFF' },
      { name: 'msapplication-TileImage', content: '/favicons/ms-icon-144x144.png' },
      // PWA primary color
      { name: 'theme-color', content: theme.primary},
      // Facebook
      { property: 'author', content: 'smartholdem' },
      { property: 'og:site_name', content: 'smartholdem.io' },
      { property: 'og:locale', content: 'en_US' },
      { property: 'og:type', content: 'website' },
      // Twitter
      { property: 'twitter:site', content: 'smartholdem' },
      { property: 'twitter:domain', content: 'smartholdem' },
      { property: 'twitter:creator', content: 'smartholdem' },
      { property: 'twitter:card', content: 'summary' },
      { property: 'twitter:image:src', content: '/images/logo.png' },
      { property: 'og:url', content: brand.sth_docs.url },
      { property: 'og:title', content: brand.sth_docs.projectName },
      { property: 'og:description', content: brand.sth_docs.desc },
      { name: 'twitter:site', content: brand.sth_docs.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.sth_docs.img },
      { property: 'og:image', content: brand.sth_docs.img },
